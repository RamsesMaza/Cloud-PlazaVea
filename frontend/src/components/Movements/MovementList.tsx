...
const MovementList: React.FC = () => {
  ...
  // Total seguro (nunca rompe)
  const totalValue = movements.reduce((sum, m) => {
    const value = Number(m.cost);
  ...
  // Función segura para formatos de dinero
        ...
        <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{safeMoney(totalValue)}</p>
            </div>
          </div>
        </div>
      </div>
                ...
                filteredMovements.map((movement) => {
                  ...
                  return (
                    <tr key={movement.id} className="hover:bg-gray-50">
                      ...
                      <td className="py-4 px-6">
                        <span className={movement.type === 'entry' ? 'text-green-600 font-medium' : 'text-red-600 font-medium'}>
